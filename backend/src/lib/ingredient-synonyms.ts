...
const SYNONYM_MAP: Record<string, string[]> = {
  ...
  'soy sauce': ['soy sauces', 'shoyu', 'tamari', 'light soy sauce', 'dark soy sauce'],
  ...
  'fish sauce': ['fish sauces', 'nam pla'],
  'oyster sauce': ['oyster sauces'],
  'hoisin sauce': ['hoisin sauces', 'hoisin'],
  'worcestershire sauce': ['worcestershire', 'worcester sauce'],
  'hot sauce': ['hot sauces', 'tabasco'],
  ...
  // Oils & Fats
  'olive oil': ['olive oils', 'extra virgin olive oil', 'evoo'],
  ...
  'coconut milk': ['coconut milks', 'coconut cream'],
